...
<select name='sortfirst'>
    ...
    <option <?php echo filter_input(INPUT_POST, 'sortfirst') === 'ASC' ? 'selected' : '';?> value="ASC">від дешевших до дорожчих</option>
    <option <?php echo filter_input(INPUT_POST, 'sortfirst') === 'DESC' ? 'selected' : '';?> value="DESC">від дорожчих до дешевших</option>
</select>
